...
let AceConnectionService = class AceConnectionService {
    constructor(http) {
        this.http = http;
    }
...
AceConnectionService.ctorParameters = () => [
...
let ConnectionComponent = class ConnectionComponent {
    constructor(connectionService, dialog) {
...
let ConnectionTestDialog = class ConnectionTestDialog {
    constructor(data) {
        this.data = data;
    }
};
ConnectionTestDialog.ctorParameters = () => [
